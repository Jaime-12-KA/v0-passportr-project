...
interface StampPokedexModalProps {
  isOpen: boolean
  onClose: () => void
  currentLanguage: string
}

const StampPokedexModal = ({ isOpen, onClose, currentLanguage }: StampPokedexModalProps) => {
    ...
    },
    {
      ...
      flavorText:
        currentLanguage === "en"
          ...
          : "조선 시대로 거슬러 올라가는 전통 한옥들로 가득한 매력적인 동네로, 한국의 건축 유산을 엿볼 �� 있는 곳입니다.",
      tips: [
        {
    ...
    },
    {
      ...
      flavorText:
        currentLanguage === "en"
          ...
          : "종종 '부산의 마추픽추'라고 불리는 이 언덕 위 마을은 다채로운 집들, 좁은 골목길, 예술적인 설치물이 특징입니다.",
      tips: [
        {
          avatar: "/images/Friends_Minji Kim.jpg",
          username: "Minji Kim",
  ...
  const getTypeColor = (type: string) => {
    ...
    return typeColors[type] || "#68A090" // Default teal color
  }
  ...
  return (
    <div className="fixed inset-0 bg-brand-sand z-50 overflow-y-auto">
      {loading ? (
        // Loading screen
        ...
        <div className="stamp-detail-view">
          ...
          <div className="sticky top-0 bg-brand-blue z-10 px-4 py-3 flex items-center justify-between border-b border-brand-coral">
            ...
            <button className="w-10 h-10 rounded-full bg-white flex items-center justify-center" onClick={onClose}>
                  ...
                  >
                    ...
                    <div className="bg-gradient-to-r from-brand-blue to-brand-blue/80 px-3 py-1 flex items-center">
                      <div className="flex items-center text-white text-xs">
                        ...
                        <span className="font-bold">{stamp.type.toUpperCase()}</span>
                      </div>
                    </div>
...
export default StampPokedexModal
